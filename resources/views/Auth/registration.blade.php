...
@section('content')
    ...
    <div class="relative flex flex-col justify-center h-screen overflow-hidden">
        <div class="w-full p-6 m-auto bg-red rounded-md shadow-md ring-2 ring-red-700/90 lg:max-w-xl">
            <h1 class="text-3xl font-semibold text-center text-red-700">Register</h1>
            <form action={{route('registerPost')}} method="POST" >
                ...
                <div>
                    <button type="submit" class="mt-2 btn btn-block bg-grey-500 hover:bg-red-600 text-xl text-red-700">Register Account</button>
                </div>
                <span>Already have an account ?
                    <a href="{{ route('logged') }}" class="text-blue-600 hover:text-blue-800 hover:underline">Login</a></span>
            </form>
